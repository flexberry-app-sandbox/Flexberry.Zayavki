...
CREATE TABLE [ApplicationLog] (
 ...
 ALTER TABLE [Услуга] ADD CONSTRAINT [Услуга_FЗаявка_0] FOREIGN KEY ([Заявка_m0]) REFERENCES [Заявка]
CREATE INDEX Услуга_IЗаявка_m0 on [Услуга] ([Заявка_m0])

 ALTER TABLE [Заявка] ADD CONSTRAINT [Заявка_FКлиент_0] FOREIGN KEY ([Клиент_m0]) REFERENCES [Клиент]
CREATE INDEX Заявка_IКлиент_m0 on [Заявка] ([Клиент_m0])
